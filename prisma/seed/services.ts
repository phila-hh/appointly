/**
 * @file Seed services — 5-10 per business, prices in ETB.
 */
...
const CATALOG: Record<string, SvcDef[]> = {
  BARBERSHOP: [
    {
      name: "Classic Haircut",
      description:
        "Traditional scissors and clipper cut. Includes wash, cut, and style.",
      price: 350,
      duration: 30,
    },
    {
    ...
    {
      name: "Kids Haircut",
      description: "Haircut for children under 12. Patient and gentle service.",
      price: 200,
      duration: 25,
    },
    {
  ...
  SALON: [
    {
      ...
      description:
        "Traditional Ethiopian cornrow braiding. Multiple styles available.",
      price: 1500,
      duration: 120,
    },
    {
      name: "Hair Relaxer Treatment",
      description: "Chemical straightening with deep conditioning follow-up.",
      price: 1200,
      duration: 90,
    },
    {
      ...
      description:
        "Smooth, frizz-free hair for up to 3 months. Premium keratin formula.",
      price: 3500,
      duration: 150,
    },
    {
    ...
    },
    {
      ...
      description: "Individual lash extensions for a natural or dramatic look.",
      price: 2000,
      duration: 90,
    },
  ],
  SPA: [
    {
      ...
      description:
        "Full-body relaxation massage with long, flowing strokes to ease tension.",
      price: 2000,
      duration: 60,
    },
    {
    ...
    },
    {
      ...
      description:
        "Therapeutic massage with heated basalt stones for deep relaxation.",
      price: 2800,
      duration: 90,
    },
    {
    ...
    },
    {
      ...
      description: "Detoxifying herbal body wrap with moisturizing follow-up.",
      price: 2000,
      duration: 60,
      isActive: false,
    },
  ...
  FITNESS: [
    {
      ...
      description:
        "One-on-one session with certified personal trainer. Custom workout plan.",
      price: 1500,
      duration: 60,
    },
    {
      ...
      description:
        "High-energy group workout. HIIT, aerobics, and dance fitness options.",
      price: 300,
      duration: 45,
    },
    {
      name: "Yoga Class",
      description:
        "Guided yoga session for all levels. Mats and props provided.",
      price: 400,
      duration: 60,
    },
    {
    ...
    },
    {
      ...
      description:
        "Unlimited gym access for one month. Locker and shower facilities included.",
      price: 3000,
      duration: 30,
    },
    {
  ...
  DENTAL: [
    ...
    },
    {
      name: "Dental Filling",
      description:
        "Tooth-colored composite filling for cavities. Local anesthesia included.",
      price: 1500,
      duration: 45,
    },
    {
    ...
    },
    {
      ...
      description:
        "In-office professional whitening. Visible results in one session.",
      price: 3500,
      duration: 60,
    },
    {
  ...
  MEDICAL: [
    ...
    },
    {
      ...
      description:
        "Wellness check for children. Growth assessment and vaccination review.",
      price: 600,
      duration: 30,
    },
    {
      ...
      description:
        "Complete blood count, liver, kidney function, and blood sugar panel.",
      price: 1500,
      duration: 15,
    },
    {
  ...
  TUTORING: [
    {
      ...
      description:
        "One-on-one math tutoring for grade 9-12. Algebra, geometry, calculus.",
      price: 500,
      duration: 60,
    },
    {
    ...
    },
    {
      ...
      description:
        "Intensive 2-hour preparation session for Ethiopian university entrance exams.",
      price: 800,
      duration: 120,
    },
    {
  ...
  PHOTOGRAPHY: [
    ...
    },
    {
      ...
      description: "Outdoor or studio family portraits. Up to 6 members.",
      price: 3500,
      duration: 90,
    },
    {
  ...
  AUTOMOTIVE: [
    ...
    },
    {
      ...
      description:
        "Computer-aided diagnostics with OBD scanner. Fault code reading and report.",
      price: 800,
      duration: 45,
    },
    {
    ...
    },
    {
      ...
      description: "AC system check, gas recharge, and filter replacement.",
      price: 2000,
      duration: 60,
    },
    {
  ...
  PET_SERVICES: [
    ...
    },
    {
      ...
      description: "Professional dental scaling and polishing under sedation.",
      price: 2500,
      duration: 60,
    },
  ],
...
export async function seedServices(
  ...
  const all: SeededService[] = [];

  for (const biz of businesses) {
    const defs = CATALOG[biz.category] ?? CATALOG.OTHER;
