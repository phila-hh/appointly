...
-- CreateEnum
CREATE TYPE "BusinessCategory" AS ENUM ('BARBERSHOP', 'SALON', 'SPA', 'FITNESS', 'DENTAL', 'MEDICAL', 'TUTORING', 'CONSULTING', 'PHOTOGRAPHY', 'AUTOMOTIVE', 'HOME_SERVICES', 'PET_SERVICES', 'OTHER');
